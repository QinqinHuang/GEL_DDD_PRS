...
fwrite(betaall, file = paste0(trait, "LDpred2_inf_grid_beta.txt"), sep = "\t")
...
write(paste0("  ...LDpred2-auto finished..."), 
      file = paste0(trait, "_LDpred2.log"), append = T)
# ?? what structure does the data look like?
#beta_auto_out = cbind(df_beta[, c("SNP_GEL","a0","a1")], beta_auto) 
#fwrite(beta_auto_out, paste0(trait, "_LDpred2_auto_betas.txt"), sep = "\t")
